...
from . import alert_escalation, appointment_reminder, clinical_notify, task_intake
...
def register_subscriptions() -> None:
    ...
    SUBSCRIBERS.setdefault(CLINICAL_ALERT, []).append(task_intake.on_clinical_alert)

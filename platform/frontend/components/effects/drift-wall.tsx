...
/** Drifting parallax wall of image tiles, tilted in 3D and reacting to the
 * pointer. Vendored from reactbits.dev's "DriftWall" — animation/pointer
 * logic unchanged; the only behavioral change is that `items` has no
 * built-in default (the landing page always supplies real product
 * screenshots — see components/landing/product-wall.tsx). */

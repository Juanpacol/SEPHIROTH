...
/** Vendored from magicui.design — no v4-only Tailwind syntax here, so this
 * is unchanged from upstream aside from the `motion/react` import (same
 * package name magicui uses; already a dependency via the Dock effect). */
  ...
  const finalVariants = variants
    ? {
        container: {
          ...
          show: {
            opacity: 1,
            transition: { opacity: { duration: 0.01, delay }, delayChildren: delay, staggerChildren: duration / segments.length },
          },

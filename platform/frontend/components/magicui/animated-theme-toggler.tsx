...
/** Vendored from magicui.design, unchanged (no v4-only Tailwind classes to
 * port — it's all plain motion/DOM logic + the browser's native View
 * Transitions API). Used here in its "controlled" mode: `components/
 * theme-toggle.tsx` owns the actual light/dark/system state (our
 * pre-existing tri-state `lib/theme.ts`) and just asks this component to
 * animate between the current and next *resolved* appearance. */
...
interface AnimatedThemeTogglerProps extends React.ComponentPropsWithoutRef<"button"> {
  ...
  fromCenter?: boolean;
  /** Controlled theme value. When provided, the parent owns persistence and this component will not write to localStorage. */
  theme?: "light" | "dark";

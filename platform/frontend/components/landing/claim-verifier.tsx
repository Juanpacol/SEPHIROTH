          ...
          return (
            <div key={claim.text}>
              ...
              >
                ...
                <span className="underline decoration-dotted underline-offset-2">{claim.text}</span>
              </button>
              {expanded && (
                <div
                  id={`claim-panel-${i}`}
                ...
                >
                  <div className={`mb-1 text-xs font-semibold ${legend.color}`}>{legend.label}</div>
                  <p className="text-muted">{claim.evidence}</p>
                  <p className="mt-2 font-medium">{claim.action}</p>
                </div>
              )}
            </div>
          );

 ...
 *
 * Moved out of the page in SPEC-024, which made the review inbox the primary
 * view: what was *sent* and what is *unread* are two halves of one story, and
 * the second half needed the top of the page.
 *
...
export default function SharedResultsList() {
  const { t } = useLanguage();

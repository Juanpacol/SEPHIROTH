...
import PreVisitBriefPanel from "@/components/encounters/pre-visit-brief";
...
export default function EncounterPage() {
  ...
  const briefQuery = useQuery({
    queryKey: ["pre-visit", encounter?.patient_id],
    queryFn: () => api.preVisitBrief(encounter!.patient_id),
    enabled: Boolean(encounter?.patient_id),
  });
  ...
  return (
    <div className="flex flex-col gap-4 pb-24 md:pb-6">
      ...
      {briefQuery.data ? <PreVisitBriefPanel brief={briefQuery.data} /> : null}

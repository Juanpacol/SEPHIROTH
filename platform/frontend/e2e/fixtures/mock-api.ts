    ...
    items: [
      {
        ...
        vitals: { weight: 78.4, height: 164, systolic: 150, diastolic: 92 },
        vital_findings: [],
        subjective: "",
        objective: "",
        assessment: "",
        ...
        note_source: "clinician" as const,
        note_model: null,
        editable: false,
        signable: false,
        started_at: iso(-90, 9),
        signed_at: iso(-90, 10),
        signed_by: "u-clinician",
        amended_at: null,
        amendment_reason: "",

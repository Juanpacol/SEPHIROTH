...
# Run with PYTHONPATH=.:platform (same convention pytest/uvicorn already use
# — see CLAUDE.md's "Important" note on why `platform/` isn't a package).
from core.config import settings  # noqa: E402
from data.schemas import Base  # noqa: E402

# Changelog — Archive (Phase 0 through DEBT-010)

Older entries moved out of `CHANGELOG.md` to keep it under 300 lines. Same
format ([Keep a Changelog](https://keepachangelog.com/en/1.1.0/)), no content
lost — see `CHANGELOG.md` for everything from Phase 5 Part 1 onward.
